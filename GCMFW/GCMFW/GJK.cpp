...
//
//	Vertex* vertData0 = mesh0->getVertexData();
//	Vertex* vertData1 = mesh1->getVertexData();
//
//	Vector3* Object0Vertices = new Vector3[mesh0->getNumVertices()];
//	Vector3* Object1Vertices = new Vector3[mesh1->getNumVertices()];
//
//	for (int x = 0; x < mesh0->getNumVertices(); ++x)
//	{
//		Object0Vertices[x] = Vector3(vertData0->x, vertData0->y, vertData0->z);
//	}
//
//	for (int x = 0; x < mesh1->getNumVertices(); ++x)
//	{
//		Object1Vertices[x] = Vector3(vertData1->x, vertData1->y, vertData1->z);
//	}
//
//
...
//
//	Matrix4 orientation0 (n0.GetOrientation(), Vector3(0,0,0));
//	Matrix4 orientation1 (n1.GetOrientation(), Vector3(0, 0, 0));
//
...
//		Object0FixedVertices[x] = Object0Matrix.getUpper3x3() * Object0Vertices[x];
//
//	for (int x = 0; x < Object1VertexCount; x++)
//		Object1FixedVertices[x] = Object1Matrix.getUpper3x3() * Object1Vertices[x];
//
...
//	}
//	//DoubleCross
//	dir = cross(cross(c.getPoint() - b.getPoint(), -b.getPoint()), c.getPoint() - b.getPoint());
//
//	nrPointsSimplex = 2;
//
//	int steps = 0;
...
//
//				float distToOrigin = -3.402823466e+38F;
//
//				int count = 0;
...
//					float vecLength = dot(entry_cur_support.getPoint(), tempT.triNormal);
//
...
//					{
//						Triangle& t = *i;
//						if (dot(t.triNormal, (entry_cur_support.getPoint() - t.a.getPoint())) > 0)
//						{
//							addEdge(t.a, t.b);
//							addEdge(t.b, t.c);
//							addEdge(t.c, t.a);
...
//	//dirCopy.Normalise();
//	normalize(dirCopy);
//	Vector3 negDirCopy(-dirCopy.getX(), -dirCopy.getY(), -dirCopy.getZ());
//
//	Vector3 p1 = pt0[DirectionPoint(pt0, point0Count, dirCopy)];
//	Vector3 p2 = pt1[DirectionPoint(pt1, point1Count, negDirCopy)];
//
//	Vector3 p3 = p1 - p2;
...
//{
//	float maxproj = -3.402823466e+38F;
//	int indexPosition;
//
...
//	{
//		float triValue = dot(t.triNormal, t.a.getPoint());
//
//		if (triValue < value)
//		{
//			value = triValue;
