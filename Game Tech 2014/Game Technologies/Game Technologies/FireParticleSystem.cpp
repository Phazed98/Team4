...
void FireParticleSystem::Render(int DeltaTimeMillis, const Matrix4& viewMatrix, const Matrix4& projMatrix, const Vector3& CameraPos)
{
...
void FireParticleSystem::RenderParticles(const Matrix4& viewMatrix, const Matrix4& projMatrix)
{
